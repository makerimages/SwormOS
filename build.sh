...
i686-elf-g++ -c src/drivers/PIC.cpp -o dist/drivers/PIC.o -ffreestanding -O2 -Wall -Wextra -fno-exceptions -fno-rtti
i686-elf-g++ -c src/kernel/Kernel.cpp -o dist/kernel/Kernel.o -ffreestanding -O2 -Wall -Wextra -fno-exceptions -fno-rtti
...
i686-elf-gcc -T src/linker.ld -o dist/OSZin.bin -ffreestanding -O2 -nostdlib dist/boot.o dist/interrupt-entry.o dist/kernel/Kernel.o dist/drivers/Terminal.o dist/drivers/PIC.o dist/drivers/System.o dist/drivers/Interrupts.o dist/drivers/Interrupt.o dist/drivers/gdt.o  dist/drivers/InterruptDescriptorTable.o -lgcc
cd dist
mkdir -p isodir
mkdir -p isodir/boot
