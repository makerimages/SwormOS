...
i686-elf-gcc -T src/linker.ld -o dist/OSZin.bin -ffreestanding -O2 -nostdlib dist/boot.o dist/Kernel.o dist/drivers/Terminal.o dist/drivers/System.o dist/drivers/Interrupts.o dist/drivers/gdt.o  -lgcc
cd dist
mkdir -p isodir
mkdir -p isodir/boot
